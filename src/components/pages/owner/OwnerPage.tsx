...
const OwnerPage = () => {
    return (
        <article className='flex flex-col-reverse sm:flex-row sm:items-center sm:justify-evenly gap-4 sm:gap-10 pt-6 px-4 bg-orange-100 sm:m-auto text-neutral-900'>

            <div>
                <Image src={'/images/jefe.png'} alt={''} width={400} height={200} />
            </div>
